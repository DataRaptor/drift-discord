...
export const postCreateDiscordRedirectRoute = async(req: express.Request, res: express.Response) => {
    try{
...
export const getDiscordUserRoute = async(req: express.Request, res: express.Response) => {
    try{
